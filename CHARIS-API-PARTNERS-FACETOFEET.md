...
## GET /v1/partners/facetofeet/saelgoods/search/:keyword
...
Field | Type | Description | Default
---|---|---|---
keyword | String | Name of Product or Brand | ''
...
##### Search API
```
GET /v1/partners/facetofeet/salegoods/search/:keyword?page=1&limit=10 HTTP/1.1
Host: api.hicharis.net
Content-Type: application/json
Authorization: Basic __BASIC_TOKEN__
```
